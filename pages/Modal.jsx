...
export default class Tour extends React.Component {
    constructor(props) {
        ...
        this.state = {
            styleTicketModal: { display: 'none' }
        }

        events.on('modal', ()=>{
            this.toogleModalTicket();
        });
    ...
    toogleModalTicket() {
        this.setState({
            styleTicketModal: {
                display: this.state.styleTicketModal.display == 'block' ? 'none' : 'block'
            }
        });
    }
    ...
    render() {
        return (
            <div id="ticketModal" className="w3-modal" style={{ ...this.state.styleTicketModal }}>
                <div className="w3-modal-content w3-animate-top w3-card-4">
                    <header className="w3-container w3-teal w3-center w3-padding-32">
                        <span onClick={this.toogleModalTicket}
                    ...
                    <div className="w3-container">
                        ...
                        <button className="w3-button w3-red w3-section" onClick={this.toogleModalTicket}>Close <i className="fa fa-remove"></i></button>
