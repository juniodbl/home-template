...
export default class Tour extends React.Component {
    constructor(props) {
        super(props);
        this.toogleModalTicket = this.toogleModalTicket.bind(this);
    }
                ...
                <div className="w3-container w3-content w3-padding-64" style={{ maxWidth: '800px' }}>
                    ...
                    <div className="w3-row-padding w3-padding-32" style={{ margin: '0 -16px' }}>
                        <div className="w3-third w3-margin-bottom">
                            <img src="/static/newyork.jpg" alt="New York" style={{ width: '100%' }} className="w3-hover-opacity" />
                            <div className="w3-container w3-white">
                                <p><b>New York</b></p>
                                <p className="w3-opacity">Fri 27 Nov 2016</p>
                                <p>Praesent tincidunt sed tellus ut rutrum sed vitae justo.</p>
                                <button className="w3-button w3-black w3-margin-bottom" onClick={this.toogleModalTicket}>Buy Tickets</button>
                            </div>
                        </div>
                        <div className="w3-third w3-margin-bottom">
                            <img src="/static/paris.jpg" alt="Paris" style={{ width: '100%' }} className="w3-hover-opacity" />
                            <div className="w3-container w3-white">
                                <p><b>Paris</b></p>
                        ...
                        <div className="w3-third w3-margin-bottom">
                            <img src="/static/sanfran.jpg" alt="San Francisco" style={{ width: '100%' }} className="w3-hover-opacity" />
                            <div className="w3-container w3-white">
